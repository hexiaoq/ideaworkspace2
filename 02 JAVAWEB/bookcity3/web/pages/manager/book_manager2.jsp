	...
	<div id="main">
		<table>
			...
			<tr>
				...
				<td><a href="http://192.168.0.105:8080/bookcity3/manager/bookservlet?action=getbook&&id=${book.id}&&pageNo=${requestScope.page.pageNo}">修改</a></td>
			</tr>
			</c:forEach>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="http://192.168.0.105:8080/bookcity3/pages/manager/book_add.jsp?pageNo=${requestScope.page.pagetotal}">添加图书</a></td>
			</tr>	
		</table>
	</div>
	</div>
