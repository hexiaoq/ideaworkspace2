...
<link type="text/css" rel="stylesheet" href="http://192.168.0.105:8080/bookcity3/static/css/style.css" >
	...
	$(function () {
		$("#name").blur(function () {
			...
			$.getJSON("http://192.168.0.105:8080/bookcity3/userservlet","action=ajaxexistname&username="+username,function (data) {
		...
		$("#code_img").click(function () {
			this.src="http://192.168.0.105:8080/bookcity3/kaptcha.jpg?d="+new Date();
		});
				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							...
							<div class="form">
								<form action="http://192.168.0.105:8080/bookcity3/userservlet" method="post">
									...
									<img  id="code_img" alt="" src="http://192.168.0.105:8080/bookcity3/kaptcha.jpg" style="float: right; margin-right: 40px; height:26px;width: 100px">
									<br />
									<br />
