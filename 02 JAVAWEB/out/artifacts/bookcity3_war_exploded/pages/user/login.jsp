				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							<div class="tit">
								<h1>尚硅谷会员</h1>
								<a href="http://192.168.0.105:8080/bookcity3/pages/user/regist.jsp">立即注册</a>
							</div>
							<div class="msg_cont">
								<b></b>
							...
							<div class="form">
								<form action="http://192.168.0.105:8080/bookcity3/userservlet" method="post">
									...
									<img alt="" src="http://192.168.0.105:8080/bookcity3/kaptcha.jpg" style="float: right; margin-right: 40px; height:26px;width: 100px">
									<br />
									<br />
