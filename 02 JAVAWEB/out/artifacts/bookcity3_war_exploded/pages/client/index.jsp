    ...
    <script type="text/javascript">
        $(function () {
         $(".addtocart").click(function () {
             ...
             location.href="http://192.168.0.105:8080/bookcity3/cartservlet?action=additems&page=&id="+attr;
	...
	<div id="header">
			...
			<div>
				<c:if test="${empty sessionScope.username}">
					<a href="http://192.168.0.105:8080/bookcity3/pages/user/login.jsp">登录</a> |
					<a href="http://192.168.0.105:8080/bookcity3/pages/user/regist.jsp">注册</a> </c:if>
				...
				<a href="http://192.168.0.105:8080/bookcity3/pages/cart/cart.jsp">购物车</a>
				<a href="http://192.168.0.105:8080/bookcity3/pages/manager/manager.jsp">后台管理</a>
			</div>
	</div>
	<div id="main">
		<div id="book">
			<div class="book_cond">
				<form action="http://192.168.0.105:8080/bookcity3/client/bookservlet" method="get">
			...
			<c:forEach items="${requestScope.page.items}" var="book">
				<div class="b_list">
				<div class="img_div">
					<img class="book_img" alt="" src="http://192.168.0.105:8080/bookcity3/static/img/default.jpg" />
				</div>
				<div class="book_info">
					<div class="book_name">
